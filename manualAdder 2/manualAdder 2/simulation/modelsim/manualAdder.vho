...
clock : maxii_lcell
-- Equation(s):
-- \clock~combout\ = LCELL(((\clk~combout\ & ((\r~regout\)))))
...
-- Equation(s):
-- \d1|Equal0~0\ = (\d1|counter\(3) & (\d1|counter\(1) & (B1_counter[4] & \d1|counter\(2))))
...
-- Equation(s):
-- \d1|Equal0~5\ = (!\d1|counter\(7) & (!\d1|counter\(8) & (B1_counter[5] & !\d1|counter\(6))))
...
-- Equation(s):
-- \d1|Equal0~4\ = (!\d1|counter\(10) & (!\d1|counter\(11) & (!B1_counter[12] & \d1|counter\(9))))
...
-- Equation(s):
-- \d1|Equal0~2\ = (!\d1|counter\(13) & (\d1|counter\(14) & (!B1_counter[15] & \d1|counter\(16))))
...
-- Equation(s):
-- \d1|counter\(16) = DFFEAS((((\d1|Add0~40_combout\ & !\d1|Equal0~6_combout\))), GLOBAL(\clock~combout\), !\rst~combout\, , , , , , )
...
-- Equation(s):
-- \d1|counter\(17) = DFFEAS(((!\d1|Equal0~6_combout\ & ((\d1|Add0~35_combout\)))), GLOBAL(\clock~combout\), !\rst~combout\, , , , , , )
...
-- Equation(s):
-- \d1|counter\(18) = DFFEAS((((\d1|Add0~30_combout\ & !\d1|Equal0~6_combout\))), GLOBAL(\clock~combout\), !\rst~combout\, , , , , , )
...
-- Equation(s):
-- \d1|counter\(1) = DFFEAS((((\d1|Add0~15_combout\))), GLOBAL(\clock~combout\), !\rst~combout\, , , , , , )
...
-- Equation(s):
-- \d1|Equal0~3_combout\ = (\d1|counter\(18) & (\d1|counter\(17) & (\d1|Equal0~2\ & \d1|Equal0~1\)))
...
-- Equation(s):
-- \d1|Equal0~6_combout\ = (\d1|Equal0~0\ & (\d1|Equal0~4\ & (\d1|Equal0~5\ & \d1|Equal0~3_combout\)))
...
-- Equation(s):
-- \out1|n1|Mux6~0_combout\ = (\d6|Q~regout\) # ((\d5|Q~regout\ & ((\d3|Q~regout\) # (\d4|Q~regout\))))
...
-- Equation(s):
-- \out1|temp[3]~13_combout\ = ((!\d5|Q~regout\ & (!\d4|Q~regout\)))
...
-- Equation(s):
-- \out1|LessThan0~0_combout\ = (!\d5|Q~regout\ & (!\d6|Q~regout\ & ((!\out1|LessThan4~0_combout\) # (!\d4|Q~regout\))))
...
PORT MAP (
	...
	datab => \d5|Q~regout\,
	datac => \d6|Q~regout\,
	datad => \out1|LessThan4~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \out1|h1[0]~6_combout\ = (\d5|Q~regout\ & (!\d6|Q~regout\ & ((\d3|Q~regout\) # (\d4|Q~regout\)))) # (!\d5|Q~regout\ & (((\d6|Q~regout\ & !\d4|Q~regout\))))
...
-- Equation(s):
-- \out1|h1[0]~8_combout\ = ((!\d2|Q~regout\ & (!\d3|Q~regout\ & !\d4|Q~regout\))) # (!\out1|LessThan5~1_combout\)
...
PORT MAP (
	dataa => \d2|Q~regout\,
	datab => \d3|Q~regout\,
	datac => \out1|LessThan5~1_combout\,
	datad => \d4|Q~regout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \out1|LessThan5~0_combout\ = (((!\d4|Q~regout\) # (!\d6|Q~regout\)) # (!\d5|Q~regout\)) # (!\d3|Q~regout\)
...
-- Equation(s):
-- \out1|h1[1]~7_combout\ = (\out1|h1[0]~8_combout\ & (!\out1|LessThan0~0_combout\ & (\out1|h1[0]~6_combout\))) # (!\out1|h1[0]~8_combout\ & (((!\out1|LessThan5~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \out1|LessThan0~0_combout\,
	datab => \out1|h1[0]~6_combout\,
	datac => \out1|h1[0]~8_combout\,
...
-- Equation(s):
-- \out1|temp[1]~12_combout\ = ((\d3|Q~regout\ & ((!\d4|Q~regout\) # (!\d2|Q~regout\))) # (!\d3|Q~regout\ & ((\d4|Q~regout\))))
...
-- Equation(s):
-- \out1|h1[0]~4_combout\ = (\d5|Q~regout\ & (!\out1|temp[1]~12_combout\ & (!\d6|Q~regout\))) # (!\d5|Q~regout\ & (((!\d4|Q~regout\) # (!\d6|Q~regout\))))
...
-- Equation(s):
-- \out1|h1[0]~5_combout\ = (\out1|h1[0]~8_combout\ & (!\out1|LessThan0~0_combout\ & (\out1|h1[0]~4_combout\))) # (!\out1|h1[0]~8_combout\ & (((\out1|LessThan5~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \out1|temp[3]~13_combout\,
	datab => \out1|h1[1]~7_combout\,
	datac => \d6|Q~regout\,
...
-- Equation(s):
-- \out1|n1|Mux4~0_combout\ = (\out1|h1[0]~5_combout\) # ((!\out1|temp[3]~13_combout\ & (!\out1|h1[1]~7_combout\ & \d6|Q~regout\)))
...
-- Equation(s):
-- \out1|n1|Mux2~3_combout\ = (\d4|Q~regout\ & (((!\d2|Q~regout\)) # (!\d3|Q~regout\))) # (!\d4|Q~regout\ & (\d3|Q~regout\))
...
-- Equation(s):
-- \out1|n1|Mux1~9_combout\ = (((\out1|n1|Mux1~3_combout\ & !\d4|Q~regout\)) # (!\d6|Q~regout\)) # (!\d5|Q~regout\)
...
-- Equation(s):
-- \out1|temp[3]~7_combout\ = (\d3|Q~regout\ & (!\d4|Q~regout\ & (!\d5|Q~regout\ & \d2|Q~regout\))) # (!\d3|Q~regout\ & (\d5|Q~regout\ & (\d4|Q~regout\ $ (!\d2|Q~regout\))))
...
-- Equation(s):
-- \out1|temp[3]~6_combout\ = (\d4|Q~regout\ & (!\d2|Q~regout\ & (\d3|Q~regout\ $ (!\d5|Q~regout\)))) # (!\d4|Q~regout\ & (!\d3|Q~regout\ & (\d5|Q~regout\ & \d2|Q~regout\)))
...
-- Equation(s):
-- \out1|temp[1]~10_combout\ = (\d4|Q~regout\ & ((\d3|Q~regout\ & (!\d5|Q~regout\ & !\d2|Q~regout\)) # (!\d3|Q~regout\ & (\d5|Q~regout\ & \d2|Q~regout\)))) # (!\d4|Q~regout\ & (\d2|Q~regout\ $ (((!\d3|Q~regout\ & \d5|Q~regout\)))))
...
-- Equation(s):
-- \out1|temp[2]~2_combout\ = (\d2|Q~regout\ & (\d3|Q~regout\ $ (((\d6|Q~regout\ & !\d4|Q~regout\))))) # (!\d2|Q~regout\ & (\d3|Q~regout\ & ((\d6|Q~regout\) # (!\d4|Q~regout\))))
...
-- Equation(s):
-- \out1|temp[2]~3_combout\ = (\d2|Q~regout\ & ((\d6|Q~regout\ & (!\d4|Q~regout\ & \d3|Q~regout\)) # (!\d6|Q~regout\ & (\d4|Q~regout\ & !\d3|Q~regout\)))) # (!\d2|Q~regout\ & (!\d3|Q~regout\ & ((\d4|Q~regout\) # (!\d6|Q~regout\))))
...
-- Equation(s):
-- \out1|n2|Mux6~0_combout\ = (\out1|temp[1]~16_combout\ & ((\out1|temp[3]~15_combout\ $ (!\out1|temp[2]~14_combout\)) # (!\d1|Q~regout\))) # (!\out1|temp[1]~16_combout\ & (\out1|temp[3]~15_combout\ $ ((\out1|temp[2]~14_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \out1|temp[3]~15_combout\,
	datab => \out1|temp[1]~16_combout\,
	datac => \out1|temp[2]~14_combout\,
	datad => \d1|Q~regout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \out1|n2|Mux5~0_combout\ = (!\out1|temp[3]~15_combout\ & ((\out1|temp[1]~16_combout\ & ((\d1|Q~regout\) # (!\out1|temp[2]~14_combout\))) # (!\out1|temp[1]~16_combout\ & (!\out1|temp[2]~14_combout\ & \d1|Q~regout\))))
...
-- Equation(s):
-- \out1|n2|Mux2~0_combout\ = (\out1|temp[3]~15_combout\ & (\out1|temp[2]~14_combout\ & ((\out1|temp[1]~16_combout\) # (!\d1|Q~regout\)))) # (!\out1|temp[3]~15_combout\ & (\out1|temp[1]~16_combout\ & (!\out1|temp[2]~14_combout\ & !\d1|Q~regout\)))
...
-- Equation(s):
-- \out1|n2|Mux0~0_combout\ = (\out1|temp[3]~15_combout\ & (\d1|Q~regout\ & (\out1|temp[1]~16_combout\ $ (\out1|temp[2]~14_combout\)))) # (!\out1|temp[3]~15_combout\ & (!\out1|temp[1]~16_combout\ & (\out1|temp[2]~14_combout\ $ (\d1|Q~regout\))))
